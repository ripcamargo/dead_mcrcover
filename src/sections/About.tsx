    ...
    <section className="about-section" id="about" ref={ref}>
      ...
      >
        ...
        <p style={{ textAlign: 'justify' }}>
          Formada em Sorocaba/SP, a <b>DEAD!</b> nasceu da paixão em comum de cinco músicos pelo <b>My Chemical Romance</b>. Mais do que interpretar suas músicas, a proposta da banda é trazer a intensidade, a emoção e a identidade que transformaram o MCR em uma das maiores referências do rock alternativo dos anos 2000. Cada apresentação é pensada para entregar uma experiência imersiva, unindo performance, sonoridade e estética em um tributo à altura de seu legado.
</p>
      </motion.div>
      <motion.div
